...
import logo from "public/logo/shahab-munir-logo.png";
import logoLight from "public/logo/shahab-munir-logo.png";
                ...
                <nav className="navbar p-0">
                  <div className="navbar__logo">
                    <Link href="/" aria-label="go to home">
                      <Image src={logoSrc} alt="Image" priority height={80} />
                    </Link>
                  </div>
